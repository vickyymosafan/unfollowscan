...
import styles from './AnimatedGuideButton.module.css';

export default function AnimatedGuideButton() {
    return (
        <Link href="/panduan" className={styles.button}>
            Lihat Panduan
