  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
      {statCards.map((stat, index) => (
        <div
          key={index}
          className="group relative bg-white rounded-2xl p-5 border border-shark-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
        >
          {/* Content */}
          <div className="relative">
            ...
            {/* Label */}
            <p className="text-xs font-medium text-shark-600 mb-1 uppercase tracking-wide">
              {stat.label}
            </p>

            {/* Value */}
            <p className="text-3xl font-bold text-shark-950 tabular-nums">
